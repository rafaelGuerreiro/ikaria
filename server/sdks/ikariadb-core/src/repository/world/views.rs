...
pub fn vw_world_map_v1(ctx: &ViewContext) -> RawQuery<MapV1> {
    ctx.from.map_v1().build()
}

#[view(accessor = vw_world_my_character_positions_v1, public)]
...
pub fn vw_nearby_characters_v1(ctx: &ViewContext) -> RawQuery<CharacterV1> {
