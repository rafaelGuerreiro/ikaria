use crate::repository::character::{
    ...
    character_v1__view, current_character_v1__view,
};
use spacetimedb::{RawQuery, ViewContext, view};

#[view(accessor = vw_character_me_v1, name = "vw_character_me_v1", public)]
...
#[view(accessor = vw_character_me_stats_v1, name = "vw_character_me_stats_v1", public)]
...
#[view(accessor = vw_character_all_mine_v1, name = "vw_character_all_mine_v1", public)]
...
#[view(accessor = vw_character_all_mine_stats_v1, name = "vw_character_all_mine_stats_v1", public)]
