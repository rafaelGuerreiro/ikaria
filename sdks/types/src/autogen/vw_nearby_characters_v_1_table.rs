...
/// like `ctx.db.vw_nearby_characters_v_1().on_insert(...)`.
pub struct VwNearbyCharactersV1TableHandle<'ctx> {
...
pub struct VwNearbyCharactersV1InsertCallbackId(__sdk::CallbackId);
pub struct VwNearbyCharactersV1DeleteCallbackId(__sdk::CallbackId);

impl<'ctx> __sdk::Table for VwNearbyCharactersV1TableHandle<'ctx> {
    ...
    type InsertCallbackId = VwNearbyCharactersV1InsertCallbackId;

    fn on_insert(
        &self,
        callback: impl FnMut(&Self::EventContext, &Self::Row) + Send + 'static,
    ) -> VwNearbyCharactersV1InsertCallbackId {
        VwNearbyCharactersV1InsertCallbackId(self.imp.on_insert(Box::new(callback)))
    }

    fn remove_on_insert(&self, callback: VwNearbyCharactersV1InsertCallbackId) {
        self.imp.remove_on_insert(callback.0)
    }

    type DeleteCallbackId = VwNearbyCharactersV1DeleteCallbackId;

    fn on_delete(
        &self,
        callback: impl FnMut(&Self::EventContext, &Self::Row) + Send + 'static,
    ) -> VwNearbyCharactersV1DeleteCallbackId {
        VwNearbyCharactersV1DeleteCallbackId(self.imp.on_delete(Box::new(callback)))
    }

    fn remove_on_delete(&self, callback: VwNearbyCharactersV1DeleteCallbackId) {
