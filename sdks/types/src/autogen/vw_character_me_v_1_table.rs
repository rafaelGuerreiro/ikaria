...
/// like `ctx.db.vw_character_me_v_1().on_insert(...)`.
pub struct VwCharacterMeV1TableHandle<'ctx> {
...
pub struct VwCharacterMeV1InsertCallbackId(__sdk::CallbackId);
pub struct VwCharacterMeV1DeleteCallbackId(__sdk::CallbackId);

impl<'ctx> __sdk::Table for VwCharacterMeV1TableHandle<'ctx> {
    ...
    type InsertCallbackId = VwCharacterMeV1InsertCallbackId;

    fn on_insert(
        &self,
        callback: impl FnMut(&Self::EventContext, &Self::Row) + Send + 'static,
    ) -> VwCharacterMeV1InsertCallbackId {
        VwCharacterMeV1InsertCallbackId(self.imp.on_insert(Box::new(callback)))
    }

    fn remove_on_insert(&self, callback: VwCharacterMeV1InsertCallbackId) {
        self.imp.remove_on_insert(callback.0)
    }

    type DeleteCallbackId = VwCharacterMeV1DeleteCallbackId;

    fn on_delete(
        &self,
        callback: impl FnMut(&Self::EventContext, &Self::Row) + Send + 'static,
    ) -> VwCharacterMeV1DeleteCallbackId {
        VwCharacterMeV1DeleteCallbackId(self.imp.on_delete(Box::new(callback)))
    }

    fn remove_on_delete(&self, callback: VwCharacterMeV1DeleteCallbackId) {
...
pub trait vw_character_me_v_1QueryTableAccess {
    #[allow(non_snake_case)]
