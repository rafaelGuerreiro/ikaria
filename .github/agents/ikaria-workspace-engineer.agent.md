...
description: Implements and refactors Rust workspace-wide changes for Ikaria across bins/* and sdks/* with strict shared-dependency wiring.
...
1. Keep `bins/*` for binaries and `sdks/*` for reusable crates.
2. Add/adjust versions in root `[workspace.dependencies]` first.
