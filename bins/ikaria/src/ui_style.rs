...
pub mod character_select {
    ...
    pub const NAME_PLACEHOLDER_INACTIVE: &str = "(Click to type name)";
    ...
    pub const CREATE_HELP_TEXT: &str = "Click the name field, type letters/spaces, choose gender, then click Create Character";
    ...
    pub const STATUS_DEFAULT_TEXT: &str = "Click the name box, choose a gender, then click Create Character";
